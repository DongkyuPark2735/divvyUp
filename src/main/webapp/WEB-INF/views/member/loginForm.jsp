			...
			<table>
				...
				<tr>
					<td colspan="2"><input type="submit" value="LOGIN"> <input
						type="button" value="AMODE"
						onclick="location='${conPath}/admin/adminloginForm.do'"></td>
				</tr>
			</table>
		</form>
		<button onclick="location='${conPath}/qboard/listQboardForMember.do'">QBOARD</button>
		<p>
			<input type="button" value="임시 그룹게시판 이동 버튼"
				onclick="location.href='${conPath}/groupboard/groupDetil.do?gid=100'">
		</p>
		<input type="button" value="임시 그룹게시판 이동 버튼"
			onclick="location.href='${conPath}/groupboard/groupDetil.do?gid=1'">
		</p>
	</div>
</body>
</html>