...
SELECT * FROM GROUPS WHERE GID IN(SELECT GID FROM GROUPDETAIL WHERE MID='aaa') ORDER BY GRDATE;
...
CREATE TABLE ABOARD(
    ...
    SELECT TO_MID FROM FOLLOW WHERE FROM_MID='aaa';
...
CREATE SEQUENCE LOCATION_SEQ MAXVALUE 9999999999 NOCYCLE NOCACHE;

DROP TABLE LOCATION;

CREATE TABLE LOCATION(
    LID NUMBER(6) PRIMARY KEY,
    LADDRESS VARCHAR2(300),
    EID NUMBER(6) REFERENCES EVENT(EID) NOT NULL);
